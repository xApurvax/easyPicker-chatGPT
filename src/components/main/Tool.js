...
const Tool = () => {
  ...
  const { scanEffect,generateHeadlineEffect,headlineLength,headlineType, isFindUseSynonyms, isIncPowerWords, isMakeQuestion,count,allTitles,isLoading,goBackToSettings } = useSelector((state) => ({
