...
const Tool = () => {
  ...
  const handleChange = (e) => {
    ...
    setShowFocusedHeadline(e.target.value)
  };
            ...
            <div className="flex justify-between">
              ...
              <button
                ...
                onClick={(e) => {
                  ...
                  setEdit(false)
                  setHasFocusedHeadline(hasArticle)
                }}
                onAnimationEnd={() => {
              ...
              {goBackToSettings && <div className="m-5 px-3 py-2 bg-white rounded-md">
                ...
                <div className="flex flex-col justify-between py-3 border-solid border-b-[1px] border-[#f8f8f8]">
                  <div className="flex justify-between w-full" onClick={() => setShowFocusedHeadline(!showFocusedHeadline)}>
                    ...
                    <button className={` ${hasFocusedHeadline !== "" && showFocusedHeadline ?  "rotate-180 fill-[#48535B] ": "rotate-0 " } transition-all ease-in-out duration-300`}>
                      <BiChevronDown size={25} fill="#48535B" />
                    </button>
                  </div>
                {hasFocusedHeadline !== "" && 
                ...
                <div className="flex justify-between flex-col py-3 border-solid border-b-[1px] border-[#f8f8f8]">
                  <div className="flex justify-between w-full" onClick={() => setExpIncHeadline(!expIncHeadline)}>
                    ...
                    <button type="button" className={` ${expIncHeadline ?  "rotate-180 fill-[#48535B] ": "rotate-0 " } transition-all ease-in-out duration-500`}>
                      <BiChevronDown size={25} fill="#48535B" />
                    </button>
                  </div>
