  ...
  return (
    ...
    <div className='my-5 max-w-[90%] flex flex-col gap-5'>
      ...
      <GoHome className='cursor-pointer' onClick={(e) => {e.preventDefault();
         ...
         <p className="text-xs md:text-base text-[#353535]">We take care of your personal data and undertake to guarantee its confidentiality and security.</p>
        
        <div className='flex flex-col gap-3'>
          <h2 className="text-base md:text-lg font-600 font-bold text-[#141414]">Personal information we collect:</h2>
           <p className="text-xs md:text-base text-[#353535]">When you visit the <a href='/' className='text-[#544BB9] font-semibold max-w-[90%] break-all'>https://tagline.djsc7c8h3ryev.amplifyapp.com</a> website, we automatically collect certain information about your device, including information about your web browser, IP address, time zone, and some of the installed cookies on your device. Additionally, as you browse the Site, we collect information about the individual web pages or products you view, what websites or search terms referred you to the Site, and how you interact with the Site. We refer to this automatically-collected information as “Device Information.” Moreover, we might collect the personal data you provide to us (including but not limited to Name, Surname, Address, payment information, etc.) during registration to be able to fulfill the agreement.
          </p>
        </div>

        <div className='flex flex-col gap-3'>
        <h2 className="text-base md:text-lg font-600 font-bold text-[#141414]">Why do we process your data?</h2>
        ...
        <div className='flex flex-col gap-3'>
          <div className='flex flex-col'>
            <h2 className="text-base md:text-lg font-600 font-bold text-[#141414]">Your rights:</h2>
            <h2 className="text-base md:text-lg font-600 font-bold text-[#141414]">You have the following rights related to your personal data:</h2>
          </div>
          <div className='flex flex-col gap-0.5'>
             <p className="text-xs md:text-base text-[#353535]">● The right to be informed.</p>
             <p className="text-xs md:text-base text-[#353535]">● The right of access.</p>
             <p className="text-xs md:text-base text-[#353535]">● The right to rectification.</p>
             <p className="text-xs md:text-base text-[#353535]">● The right to erasure.</p>
             <p className="text-xs md:text-base text-[#353535]">● The right to restrict processing.</p>
             <p className="text-xs md:text-base text-[#353535]">● The right to data portability.</p>
             <p className="text-xs md:text-base text-[#353535]">● The right to object.</p>
             <p className="text-xs md:text-base text-[#353535]">● Rights in relation to automated decision-making and profiling.</p>
             <p className="text-xs md:text-base text-[#353535]">● If you would like to exercise this right, please contact us through the contact information below.</p>
        </div>
        </div>

         <p className="text-xs md:text-base text-[#353535]">Additionally, if you are a European resident, we note that we are processing your information in order to fulfill contracts we might have with you (for example, if you make an order through the Site), or otherwise to pursue our legitimate business interests listed above. Additionally, please note that your information might be transferred outside of Europe, including Canada and the United States.</p>

        <div className='flex flex-col gap-3'>
          <h2 className="text-base md:text-lg font-600 font-bold text-[#141414]">Links to other websites:</h2>
           <p className="text-xs md:text-base text-[#353535]">Our website may contain links to other websites that are not owned or controlled by us. Please be aware that we are not responsible for such other websites or third parties' privacy practices. We encourage you to be aware when you leave our website and read the privacy statements of each website that may collect personal information.</p>
        </div>

        <div className='flex flex-col gap-3'>
          <h2 className="text-base md:text-lg font-600 font-bold text-[#141414]">Information security:</h2>
           <p className="text-xs md:text-base text-[#353535]">We secure information you provide on computer servers in a controlled, secure environment, protected from unauthorized access, use, or disclosure. We keep reasonable administrative, technical, and physical safeguards to protect against unauthorized access, use, modification, and personal data disclosure in its control and custody. However, no data transmission over the Internet or wireless network can be guaranteed.</p>
        </div>

        <div className='flex flex-col gap-3'>
          <h2 className="text-base md:text-lg font-600 font-bold text-[#141414]">Legal disclosure:</h2>
           <p className="text-xs md:text-base text-[#353535]">We will disclose any information we collect, use or receive if required or permitted by law, such as to comply with a subpoena or similar legal process, and when we believe in good faith that disclosure is necessary to protect our rights, protect your safety or the safety of others, investigate fraud, or respond to a government request.</p>
        </div>
