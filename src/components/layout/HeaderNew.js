  ...
  return (
    <div>    
      ...
      <div className='relative bottom-0 pt-60px'>
        <header className="bg-[#544BB9] pt-24 pb-[44px] relative after:content-[''] after:h-[15%] after:w-full after:absolute after:top-full after:bg-[#EDF2F7] after:-translate-y-full after:z-0 h-full min-h-[96vh] flex flex-col items-center justify-center w-full">
