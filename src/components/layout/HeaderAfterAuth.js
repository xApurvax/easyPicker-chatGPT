...
const HeaderAfterAuth = ({children}) => {
  ...
  return (
    <div className='flex flex-col bg-[#544BB9] h-screen'>    
      ...
      <div className=''>
        <header className="bg-[#544BB9] relative after:content-[''] after:h-[40%] after:w-full after:absolute after:top-full after:bg-[#EDF2F7] after:-translate-y-full after:z-0 h-full min-h-[75vh] flex flex-col items-center w-full">
