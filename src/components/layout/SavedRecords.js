              ...
              return (
                ...
                <div className="flex gap-30 max-w-[100px]">
                    ...
                    {row?.heading_type.length > 0 ?
                      row?.heading_type : "No heading type included"}
                    </p>
                </div>
                </div>
              );
              ...
              return (
                ...
                <div className="flex flex-col gap-1.5 ms:gap-1.5 sm:gap-1.5 md:gap-3 lg:gap-3 w-full max-w-[300px] whitespace-pre-wrap max-h-[110px] overflow-scroll scrollbar-thumb-transparent scrollbar-track-transparent group-hover:scrollbar-thumb-[#ededed] group-hover:scrollbar-track-transparent scrollbar-thin scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar-thumb-opacity-0.3 p-2">
                      {row?.title.length > 0 ? row?.title?.split(",")?.map((title,id) => (
                        ...
                        :
                        <p className='font-medium text-[10px] leading-[10px] ms:text-[10px] ms:leading-[13px] sm:text-[10px] sm:leading-[16px] md:text-[12px] md:leading-[18px] lg:text-[14px] lg:leading-[21px] whitespace-normal text-black'>No titles were generated</p>
                      }
                </div>
                </div>
              );
    ...
    <div className="flex flex-col p-5 gap-5 rounded-xl bg-white w-full h-full">
        ...
        <div className='relative'>
            ...
            className={classNames(
              "pr-2 py-2 lg:py-1.5 text-sm ms:text-sm sm:text-base md:text-lg lg:text-base border-[1px] border-solid border-[#aab2b8] max-w-[155px] ms:max-w-[155px] sm:max-w-[180px] md:max-w-[200px] rounded-md focus:outline-none focus:border-[1px] focus:border-solid focus:border-[#544bb9]",showInputIcon ? "pl-7 pr-2 ms:pl-7 sm:pl-8 md:pl-10 lg:pl-10" : "px-6")}
            />
        ...
        <div className='flex gap-1 items-center'>
            ...
            <p className='font-semibold text-xs ms:text-xs sm:text-lg md:text-2xl lg:text-lg'>/ Bookmarks</p>
            {/* <RiArrowGoBackLine className='text-lg ms:text-lg sm:text-lg md:text-2xl lg:text-2xl cursor-pointer' /> */}
        </div>
        </div>
        <div className='min-h-[440px] h-max overflow-x-auto max-w-[100vw] border border-solid border-black rounded-md'>
