                  ...
                  {accessToken ? (
                    ...
                    <div className="flex">
                      <button
                        ...
                        className="felx font-bold text-lg px-3 py-1 rounded-md bg-[#544BB9] text-white hover:text-[#7f8389] transition duration-[0.4s] whitespace-nowrap list-none"
                      >
                        Sign in
                      </button>
                    </div>
                    ...
                    <div className="flex justify-end gap-1 ms:justify-between md:justify-end">
                      ...
                      <div className="flex justify-end items-center">
                        <button
                          ...
                          className="flex gap-6 bg-[#544BB9] px-2 py-1 h-full w-full"
                        >
