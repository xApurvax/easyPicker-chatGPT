...
const Forgot = () => {
  ...
  const { isLoading, isVerify, forgotModal, isVerified } = useSelector(
    (state) => ({
      ...
      <div className="flex p-5 ms:p-5 sm:p-5 md:p-10 lg:p-8 gap-8 rounded-xl bg-white w-full h-full ms:max-w-[90%]">
        <div className="flex flex-col gap-2 ms:gap-2 sm:gap-2 md:gap-4 lg:gap-4 h-full w-full justify-center items-center py-10 ms:py-0 lg:py-3">
          ...
          <div className="flex gap-1">
            <div
              className="font-bold text-sm text-[#544BB9] cursor-pointer"
              onClick={() => {
                      ...
                      <div className="flex gap-2 justify-center items-center">
                        ...
                        twoDigits(secondsToDisplay) === '00' ? (
                          <>
                            ...
                            <div
                              className="font-bold text-base ms:text-xs sm:text-sm md:text-base lg:text-base text-[#544BB9] cursor-pointer"
                              onClick={() => {
                                dispatch(
                                  forgotFetchAPi({ email: forgotModal?.email })
                                )
                                handleTimerStart()
                              }}
                            >
                          ...
                          <p className="font-normal text-base ms:text-xs sm:text-sm md:text-base lg:text-base text-[#4A5568]">
                            Resend OTP in{' '}
                            <span className="font-semibold text-[#544BB9]">
